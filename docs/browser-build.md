...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@baklavajs/themes@2.0.2-alpha.4/dist/syrup-dark.css" />
        <style>
            html,
            body {
                margin: 0;
    ...
    <body>
        ...
        <script src="https://cdn.jsdelivr.net/npm/baklavajs@2.0.2-alpha.8/dist/index.js"></script>
        <script>
